# Architecture | Nomad | HashiCorp Developer

*Date: 2026-02-16*

---
title: Architecture | Nomad | HashiCorp Developer
url: https://developer.hashicorp.com/nomad/docs/architecture
hostname: hashicorp.com
description: Nomad's system architecture supports a "run any workload anywhere" approach to scheduling and orchestration. Learn how regions, servers, and clients interact, and how Nomad clusters replicate data and run workloads.
sitename: HashiCorp
date: 2026-02-16
---
Architecture
